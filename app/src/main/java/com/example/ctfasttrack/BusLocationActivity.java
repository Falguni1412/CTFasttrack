...
public class BusLocationActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        if (ActivityCompat.checkSelfPermission(BusLocationActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(BusLocationActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String stringResponse) {
                        try {
                            ...
                            Toast.makeText(BusLocationActivity.this, "" + aa, Toast.LENGTH_SHORT).show();
                            mMap.clear();
                            if (aa == 1) {
...
//                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(BusLocationActivity.this, "Could not connect", Toast.LENGTH_LONG).show();
